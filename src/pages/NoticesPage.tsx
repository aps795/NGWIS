              ...
              <div className="flex items-start space-x-4 flex-1">
                ...
                <div className="space-y-1.5 flex-1">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {notice.imageUrl && (
                      <span className="inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider bg-amber-50 text-navy-950 border border-amber-300 px-2.5 py-0.5 rounded shadow-sm">
                        <FileText className="w-3 h-3 text-amber-700" />
                        <span>Doc / JPG Attached</span>
                      </span>
                    )}
